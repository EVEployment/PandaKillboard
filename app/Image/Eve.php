...
use App\Exceptions\EveImageException;
...
class Eve {
    ...
    public function url($size = null) {
        return sprintf('%s/%s/%d/%s?size=%d', $this->img_server, $this->type, $this->id, $this->variation, $size ?? $this->size);
    }
}
